    ...
    <div class="container">
        <div class="col-md-12">
            <div class="wrapper overflow-hidden">
                ...
                <form id="checkout-form" action="<?= base_url() ?>/thanhtoan/execute" enctype="multipart/form-data" method="post" accept-charset="utf-8" name='info-order'>
                    ...
                    <div class="btn-checkout frame-100-1 overflow-hidden border-pri">
                        <button id="btn-checkout" type="submit" style="width: 400px" class="pull-left bg-pri border-pri col-fff" name="dathang">Tiếp tục</button>
                    </div>
                </form>
            </div>
        </div>
