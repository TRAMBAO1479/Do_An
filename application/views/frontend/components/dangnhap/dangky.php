						...
						<div class="acc_content clearfix" style="display: block;">
							<form accept-charset="UTF-8" action="" id="customer_register" method="post">
								...
								<div class="col_full nobottommargin">
									...
									<ul>
										<li class="right" style="font-size: 0.9em">Nếu đã có tài khoản, nhấp vào <a href="<?php echo base_url() ?>dang-nhap" style="padding-right:3px;font-size: 1.1em"> ĐÂY</a>để đăng nhập !</li>
									</ul>
								</div>
							</form>
						</div>
