        ...
        <div class="container">
            <div class="col-xs-12 cp;-sm-12 col-md-4 col-lg-4 item">
                <div class="img-service">
                    <img src="public/images/support1.png" class="pull-left">
                </div>
                <div class="text-img">
                    <h4 class="pull-left clear-fix">Hỗ trợ 24/7</h4>
                    <p>Gọi ngay nếu bạn cần hỗ trợ</p>
                </div>
            </div>
            <div class="col-xs-12 cp;-sm-12 col-md-4 col-lg-4 item">
                <div class="img-service">
                    <img src="public/images/order2.png" class="pull-left">
                </div>
                <div class="text-img">
                    <h4 class="pull-left">Đặt hàng Online</h4>
                    <p>Thao tác đơn giản</p>
                </div>
            </div>
            <div class="col-xs-12 cp;-sm-12 col-md-4 col-lg-4 item">
                <div class="img-service">
                    <img src="public/images/save3.png" class="pull-left">
                </div>
                <div class="text-img">
                    <h4 class="pull-left">Tiết kiệm hơn</h4>
    ...
    <div class="container">
        <div class="banner">
            <div class="item-banner">
                <a href="">
                    <img src="public/images/set1.png">
                </a>
            </div> 
            <div class="item-banner">
                <a href="">
                    <img src="public/images/set2.png">
                </a>
            </div>
            <div class="item-banner">
                <a href="">
                    <img src="public/images/set3.png">
                </a>
            </div>
        </div>
    </div>
                    ...
                    <div class="list-product-content">
                        <?php foreach ($listProducts as $rowProducts) :?>
                            <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 product-one">
                                ...
                                <button type="button" style="width:100%"  onclick="onAddCart(<?php echo $row['id']  ?>)">Thêm vào giỏ hàng</button>
...
<section style="margin-bottom:50px" class="home-blog">
    <div class="container">
    ...
    <a style="    position: absolute; margin-left: 50%;margin-top: 12px;font-size: 18px;margin-bottom:20px;" href="tin-tuc/1">Xem thêm</a>
</section>
<!-- <section id="demos">
    <div class="container">
        <div class="brands">
...
<div style="margin-top:30px;" class="modal fade" id="getCodeModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
